...
if IS_RELEASE:
    ...
    announcement_url = (
        "https://openmpt.org/openmpt-"
        + OPENMPT_VERSION_MAJORMAJOR
        + "-"
        + OPENMPT_VERSION_MAJOR
        + "-"
        + OPENMPT_VERSION_MINOR
        + "-"
        + OPENMPT_VERSION_MINORMINOR
        + "-released"
    )
    ...
    changelog_url = (
        "https://source.openmpt.org/browse/openmpt/?op=revision&rev=" + SVNVERSION
    )
...
version = (
    ...
    + OPENMPT_VERSION_MINORMINOR
    if IS_RELEASE
    else OPENMPT_VERSION_MAJORMAJOR
    + "."
    + OPENMPT_VERSION_MAJOR
    + "."
    + OPENMPT_VERSION_MINOR
...
update = {
    ...
    "checksums": {
        ...
        "SHA3-512": hash_file_sha3_512(
            "installer/OpenMPT-" + plainversion + "-Setup.exe"
        ),
    },
...
update = {
    ...
    + "-portable-x86.zip",
    "checksums": {
        "SHA-512": hash_file_sha512(
            "installer/OpenMPT-" + plainversion + "-portable-x86.zip"
        ),
        "SHA3-512": hash_file_sha3_512(
            "installer/OpenMPT-" + plainversion + "-portable-x86.zip"
        ),
    ...
    "autoupdate_archive": {"subfolder": "", "restartbinary": "OpenMPT.exe"},
}
with open(
    "installer/"
    + "OpenMPT-"
...
update = {
    ...
    + "/OpenMPT-"
    + version
    + "-portable-x86-legacy.zip",
    "checksums": {
        "SHA-512": hash_file_sha512(
            "installer/OpenMPT-" + plainversion + "-portable-x86-legacy.zip"
        ),
        "SHA3-512": hash_file_sha3_512(
            "installer/OpenMPT-" + plainversion + "-portable-x86-legacy.zip"
        ),
...
update = {
    ...
    "checksums": {
        "SHA-512": hash_file_sha512(
            "installer/OpenMPT-" + plainversion + "-portable-amd64.zip"
        ),
        "SHA3-512": hash_file_sha3_512(
            "installer/OpenMPT-" + plainversion + "-portable-amd64.zip"
        ),
...
update = {
    ...
    + "/OpenMPT-"
    + version
    + "-portable-amd64-legacy.zip",
    "checksums": {
        "SHA-512": hash_file_sha512(
            "installer/OpenMPT-" + plainversion + "-portable-amd64-legacy.zip"
        ),
        "SHA3-512": hash_file_sha3_512(
            "installer/OpenMPT-" + plainversion + "-portable-amd64-legacy.zip"
        ),
...
update = {
    ...
    "checksums": {
        "SHA-512": hash_file_sha512(
            "installer/OpenMPT-" + plainversion + "-portable-arm.zip"
        ),
        "SHA3-512": hash_file_sha3_512(
            "installer/OpenMPT-" + plainversion + "-portable-arm.zip"
        ),
...
update = {
    ...
    "checksums": {
        "SHA-512": hash_file_sha512(
            "installer/OpenMPT-" + plainversion + "-portable-arm64.zip"
        ),
        "SHA3-512": hash_file_sha3_512(
            "installer/OpenMPT-" + plainversion + "-portable-arm64.zip"
        ),
...
def sign_file(filename):
    p = Popen(
        [
            "bin/release/vs2019-win7-static/amd64/updatesigntool.exe",
            "sign",
            "jws",
            "auto",
            filename,
